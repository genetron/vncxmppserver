...
public class XMPP2TCPMain {
	private static String gtalkUsr = "admin";

	private static String gtalkPwd = "admin";
	...
	public static void main(String[] args) throws XMPPException{
		...
		final String sender = tmpsender != null ? tmpsender : "admin@hanumantb";
		...
		long waitTime = 1000;
		do {
			con = ConnectionUtil.getXMPPConnection("10.30.25.128", 5222);
			if (con == null) {
				try {
